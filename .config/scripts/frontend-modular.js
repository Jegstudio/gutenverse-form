...
const getModularConfig = () => {
    ...
    files.forEach(file => {
        ...
        deleteTasks.push(`./gutenverse-form/assets/js/frontend/${name}.js*`);
        deleteTasks.push(`./gutenverse-form/lib/dependencies/frontend/${name}.asset.php`);
        ...
        copyTasks.push({
            ...
            destination: "./gutenverse-form/lib/dependencies/frontend/",
        });
    });
