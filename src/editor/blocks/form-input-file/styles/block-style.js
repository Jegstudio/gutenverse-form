...
const getBlockStyle = (elementId, attributes) => {
    ...
    isNotEmpty(attributes['alignment']) && data.push({
        'type': 'plain',
        'id': 'alignment',
        'selector': `.${elementId}.guten-element.guten-form-input-file .file-input-wrapper .input-wrapper`,
        'properties': [
            {
    ...
    isNotEmpty(attributes['buttonTypography']) && data.push({
        'type': 'typography',
        'id': 'buttonTypography',
    ...
    isNotEmpty(attributes['placeholderTypography']) && data.push({
        'type': 'typography',
    ...
    isNotEmpty(attributes['iconSpacing']) && data.push({
        'type': 'plain',
        'id': 'iconSpacing',
        'responsive': true,
        'selector': `.${elementId}.guten-form-input-file .file-input-wrapper .input-wrapper .file-button`,
    ...
    isNotEmpty(attributes['buttonTextColor']) && data.push({
        'type': 'color',
        'id': 'buttonTextColor',
        'selector': `.${elementId}.guten-form-input-file .file-input-wrapper .input-wrapper .file-button`,
        'properties': [
    ...
    isNotEmpty(attributes['buttonTextColorHover']) && data.push({
        'type': 'color',
    ...
    isNotEmpty(attributes['backgroundButton']) && data.push({
        'type': 'background',
        'id': 'backgroundButton',
        'selector': `.${elementId}.guten-form-input-file .file-input-wrapper .input-wrapper .file-button`,
    });

    isNotEmpty(attributes['backgroundButtonHover']) && data.push({
        'type': 'background',
    ...
    isNotEmpty(attributes['boxShadowButton']) && data.push({
        'type': 'boxShadow',
        'id': 'boxShadowButton',
        'properties': [
            {
    ...
    isNotEmpty(attributes['boxShadowButtonHover']) && data.push({
        'type': 'boxShadow',
