...
const getBlockStyle = (elementId, attributes) => {
    ...
    isNotEmpty(attributes['checkboxSize']) && data.push({
        'type': 'plain',
        'id': 'checkboxSize',
    ...
    isNotEmpty(attributes['checkboxSpace']) && data.push({
        'type': 'plain',
        'id': 'checkboxSpace',
        'selector': `.${elementId} .gutenverse-inner-input label .check:before`,
        'properties': [
    ...
    isNotEmpty(attributes['checkboxLabelColor']) && data.push({
        'type': 'color',
    ...
    isNotEmpty(attributes['checkboxTypography']) && data.push({
        'type': 'typography',
    ...
    isNotEmpty(attributes['checkboxColor']) && data.push({
        'type': 'color',
        'id': 'checkboxColor',
        'selector': `.${elementId} .gutenverse-inner-input label .check:before`,
        'properties': [
    ...
    isNotEmpty(attributes['checkboxActiveColor']) && data.push({
        'type': 'color',
    ...
    return [
        ...data,
        ...applyFilters(
            'gutenverse.input-checkbox.blockStyle',
            [],
            {
                elementId,
                attributes
