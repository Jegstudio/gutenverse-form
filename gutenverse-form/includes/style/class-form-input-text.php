...
class Form_Input_Text extends Style_Abstract {
	...
	public function generate() {
		...
		if ( isset( $this->attrs['inputColorFocus'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .gutenverse-input:focus, .{$this->element_id} .gutenverse-input:focus-visible, .{$this->element_id} .main-wrapper .input-icon-wrapper:focus-within .form-input-text-icon .icon i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon svg",
					'property'       => function ( $value ) {
						return $this->handle_color( $value, 'color' );
					},
		...
		*/
		...
		if ( isset( $this->attrs['iconHoverColor'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .main-wrapper .input-icon-wrapper:hover .form-input-text-icon .icon i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon svg",
					'property'       => function ( $value ) {
						return $this->handle_color( $value, 'color' );
					},
		...
		if ( isset( $this->attrs['iconColorGradientHover'] ) ) {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper:hover .form-input-text-icon .icon.style-gradient i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient svg", $this->attrs['iconColorGradientHover'] );
		} else {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient svg", $this->attrs['iconColorGradient'] );
		}
		...
		if ( isset( $this->attrs['iconFocusColor'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .main-wrapper .input-icon-wrapper:focus-within .form-input-text-icon .icon i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon svg",
					'property'       => function ( $value ) {
						return $this->handle_color( $value, 'color' );
					},
		...
		if ( isset( $this->attrs['iconColorGradientFocus'] ) ) {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper:focus-within .form-input-text-icon .icon.style-gradient i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient svg", $this->attrs['iconColorGradientFocus'] );
		} else {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient i, .{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-text-icon .icon.style-gradient svg", $this->attrs['iconColorGradient'] );
		}
