<?php
/**
 * Gutenverse Form_Input_Textarea
 *
 * @author Jegstudio
 * @since 1.0.0
 ...
 * @package gutenverse-form\style
 */
class Form_Input_Textarea extends Style_Abstract {
	/**
	 * Block Directory
	 *
	 * @var string
	 ...
	 * @var array
	 */
	protected $name = 'form-input-textarea';
	...
	public function generate() {
		...
		if ( isset( $this->attrs['textAlign'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".guten-element.{$this->element_id} .gutenverse-input",
					'property'       => function ( $value ) {
		...
		*/
		...
		if ( isset( $this->attrs['iconType'] ) && 'image' === $this->attrs['iconType'] ) {
			if ( isset( $this->attrs['imageWidth'] ) ) {
				$this->inject_style(
					array(
						'selector'       => ".{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-textarea-icon .icon",
						'property'       => function ( $value ) {
		...
		*/
		...
		if ( isset( $this->attrs['iconBackground'] ) ) {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper .form-input-textarea-icon .icon.style-gradient", $this->attrs['iconBackground'] );
		}
		...
		if ( isset( $this->attrs['iconHoverBgColor'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .main-wrapper .input-icon-wrapper:hover .form-input-textarea-icon .icon",
					'property'       => function ( $value ) {
						return $this->handle_color( $value, 'background-color' );
					},
		...
		if ( isset( $this->attrs['iconBackgroundHover'] ) ) {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper:hover .form-input-textarea-icon .icon.style-gradient", $this->attrs['iconBackgroundHover'] );
		}
		...
		if ( isset( $this->attrs['iconFocusBgColor'] ) ) {
			$this->inject_style(
				array(
					'selector'       => ".{$this->element_id} .main-wrapper .input-icon-wrapper:focus-within .form-input-textarea-icon .icon",
					'property'       => function ( $value ) {
						return $this->handle_color( $value, 'background-color' );
					},
		...
		if ( isset( $this->attrs['iconBackgroundFocus'] ) ) {
			$this->custom_handle_background( ".{$this->element_id} .main-wrapper .input-icon-wrapper:focus-within .form-input-textarea-icon .icon.style-gradient", $this->attrs['iconBackgroundFocus'] );
		}
