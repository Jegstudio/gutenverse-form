...
/**
 * Class Form_Input_Text Block
 *
 * @package gutenverse-form\block
 */
class Form_Input_Text extends Block_Abstract {
	/**
	 * Render content
	 *
	 * @return string
	...
	public function render_content() {
		...
		$input_name         = isset( $this->attributes['inputName'] ) ? $this->attributes['inputName'] : 'input-text-name';
		...
		$input_html = '<input
            ...
            class="gutenverse-input gutenverse-input-text"
            type="text"' . $additional_props . '/>';

		if ( $use_icon ) {
			$html  = '<div class="input-icon-wrapper input-text">';
	...
	protected function icon_content() {
		...
		$icon            = isset( $this->attributes['icon'] ) ? $this->attributes['icon'] : 'gtn gtn-user-light';
		...
		switch ( $icon_type ) {
			case 'icon':
			case 'svg':
				$html .= '<div class="form-input-text-icon type-icon">';
			...
			case 'image':
				if ( ! empty( $image ) ) {
					...
					$html .= '<div class="form-input-text-icon type-image">';
					$html .= '<div class="icon style-' . esc_attr( $icon_style_mode ) . '">';
	...
	public function render_frontend() {
		...
		$class_name = 'guten-element guten-form-input-text guten-form-input guten-input-position-' . $position . ' ' . $element_id . $display_classes . $animation_class . $custom_classes;
