...
class Form_Input_Date extends Block_Abstract {
	...
	public function render_frontend() {
		...
		$input_label        = isset( $this->attributes['inputLabel'] ) ? $this->attributes['inputLabel'] : 'Date';
		...
		$class_name = 'guten-element guten-form-input-date guten-form-input guten-input-position-' . $position . ' ' . $element_id . $display_classes . $animation_class . $custom_classes;
