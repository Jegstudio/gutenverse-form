...
class Form_Input_Textarea extends Block_Abstract {
	...
	public function render_frontend() {
		$this->attributes['inputLabel'] = isset( $this->attributes['inputLabel'] ) ? $this->attributes['inputLabel'] : 'Textarea';
		return $this->render_wrapper( $this->render_content(), 'textarea' );
	}
}
