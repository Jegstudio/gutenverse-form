...
class Form_Notice extends Block_Abstract {
	...
	private function render_notice_data() {
		$data = array(
			...
			'iconSuccessType'   => isset( $this->attributes['iconSuccessType'] ) ? $this->attributes['iconSuccessType'] : 'svg',
			'iconErrorType'     => isset( $this->attributes['iconErrorType'] ) ? $this->attributes['iconErrorType'] : 'svg',
