...
class Form_Input_Telp extends Block_Abstract {
	...
	public function render_frontend() {
		...
		$input_label        = isset( $this->attributes['inputLabel'] ) ? $this->attributes['inputLabel'] : 'Phone';
		...
		$class_name = 'guten-element guten-form-input-telp guten-form-input guten-input-position-' . $position . ' ' . $element_id . $display_classes . $animation_class . $custom_classes;
