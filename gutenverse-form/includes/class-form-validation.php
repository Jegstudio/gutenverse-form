			...
			if ( 'gutenverse/form-builder' === $block['blockName'] ) {
				if ( isset( $block['attrs']['formId'] ) ) {
					...
					if ( 'gutenverse-form' === $post_type ) {
						...
						$result['form_success_notice'] = $data['form_success_notice'] ? $data['form_success_notice'] : false;
						$result['form_error_notice']   = $data['form_error_notice'] ? $data['form_error_notice'] : false;
					}
